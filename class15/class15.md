...
Note that the conditions in metadata don’t align with counts until we
remove the first “length” column.
...
Remove the rows with zero expression values in all experiments
(columns):
...
> Now we will make a volcano plot, a commonly produced visualization
> from this type of data that we introduced last day. Basically it’s a
> plot of log2 fold change vs -log adjusted p-value.
...
packages: **Run in your R console (i.e. not your Rmarkdown doc\!)**
...
Create a vector of FileChange values that has ENTREZ identifiers as the
names of the vectors. This is the format that the gage() function wants.
...
```
    ...
    ## Info: Working in directory /Users/ezequielquevedo/Documents/BIMM_143_Bioinformatics/bimm143_github/class15
...
Include image in report: ![](hsa04110.pathview.png)
...
These are our pathways: ![](hsa04640.pathview.png)
...
Biological Process) here. *Complementary information, but at a different
level.*
